...
@OnlyIn(Dist.CLIENT)
public class NotHorseArmorLayer extends RenderLayer<NotHorseEntity, NotHorseModel> {
    private final NotHorseModel model;

    public NotHorseArmorLayer(RenderLayerParent<NotHorseEntity, NotHorseModel> p_174496_, EntityModelSet p_174497_) {
        super(p_174496_);
        this.model = new NotHorseModel(p_174497_.bakeLayer(ModelLayers.HORSE_ARMOR));
    }
