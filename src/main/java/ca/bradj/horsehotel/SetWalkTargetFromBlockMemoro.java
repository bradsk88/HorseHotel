...
public class SetWalkTargetFromBlockMemoro extends Behavior<StableAttendant> {
   ...
   public SetWalkTargetFromBlockMemoro(MemoryModuleType<GlobalPos> p_24046_, float p_24047_, int p_24048_, int p_24049_, int p_24050_) {
   ...
   private void dropPOI(StableAttendant p_24076_, long p_24077_) {
   ...
   protected void start(ServerLevel p_24059_, StableAttendant p_24060_, long p_24061_) {
   ...
   private boolean tiredOfTryingToFindTarget(ServerLevel p_24056_, StableAttendant p_24057_) {
   ...
   private boolean tooFar(StableAttendant p_24079_, GlobalPos p_24080_) {
   ...
   private boolean closeEnough(ServerLevel p_24069_, StableAttendant p_24070_, GlobalPos p_24071_) {
